...
// ***************************************************************
// Reads the Phraseend succint vectors
// ***************************************************************
void readPhraseEndVectors()
{
...
// 
// ***************************************************************
void readPhraseSourceSizeVectors()
{
...
int main(int argc, char** argv)
{
	...
	readPhraseEndVectors();
	readPhraseLiteralVectors();
	readPhraseSourceSizeVectors();
	readReferenceVector();
	...
	if( test_setup )
	{
		...
		{
			cout << "NewChar[" << file_id << ", " << i << " ]: " << (int)getNewCharforPhrase(file_id, i) << endl;	
		};

		for( int i = start ; i < (start+len) ; i++)
		{
			int source_file_id = getSourceforPhrase( file_id, i);
			cout << "Sourceid[" << file_id << ", " << i << " ]: " << (int)source_file_id << endl;	
		};
	}
